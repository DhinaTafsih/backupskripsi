    ...
    <div class="row" style="padding-left: 0 5px 0 5px">
        <div class="col-lg-5">
                     ...
                     <form method="POST" action="<?php echo e(route('kriteria.update', $datas->id_kriteria)); ?>" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <?php echo $__env->make('subkriteria.form', ['formMode' => 'edit'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </form>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bismillah\resources\views/subkriteria/edit.blade.php ENDPATH**/ ?>